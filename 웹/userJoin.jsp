...
%>
	...
	<section class ="container mt-5" style="max-width:600px;">
		<form method="post" action="./userRegisterAction.jsp">
			<table class="table table-borderded table-hover" style="text-align: center; background-color: #ffffff; color: #000000">
				<thead>
			...
			<div class="form-group">
				...
				<div class="row">
					...
					<div class="col-3 text-right">
							<button type="submit" class="btn btn-outline-secondary">JOIN</button>
						</div>
				</div>
		</form>		
	</section>
