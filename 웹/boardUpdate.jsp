...
%>
	...
	<div class="container">
	  <form method="post" action="./qnaUpdate.jsp" > <!--  enctype="multipart/form-data" -->
		...
		<tr>
			...
			<input type="hidden" name="qnaID" style="text-align:left" value="<%=qnaID%>"></td>
		</tr>
		<tr>
			<td style="width: 110px;"><h5>제목</h5></td>
			<td><input class="form-control" type="text" maxlength="50" name="qnaTitle" placeholder="제목을 입력하세요." value="<%=qna.getQnaTitle()%>"></td>
		</tr>
		<tr>
			<td style="width: 110px;"><h5>내용</h5></td>
			<td><textarea class="form-control" rows="10" name="qnaContent" maxlength="2048" placeholder="내용을 입력하세요."><%=qna.getQnaContent()%></textarea></td>
		</tr>
		<tr>
			<td style="text-align:right;" colspan="3"><input class="btn btn-secondary pull-right" type="submit" value="수정"></td>
		</tr>
		</tbody>
		</table>
		</form>
